...
- `ใครอยู่ เชียงใหม่` / `หาเพื่อน กทม` → รายชื่อเพื่อนในจังหวัดนั้น (ชื่อ, ฉายา, ที่ทำงาน) + ลิงก์เว็บที่กรองจังหวัดไว้ (`?q=`) — ตอบเฉพาะในกลุ่มหลัก หรือแชต 1:1 ของสมาชิก; `กทม` = `กรุงเทพฯ` = `กรุงเทพมหานคร`
